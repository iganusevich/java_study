 ...
 * 2018-12-03T13:43:53.718+02:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "CountryInfoService",
                  wsdlLocation = "file:src/main/resources/CountryInfoService.wsdl",
...
public class CountryInfoService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:src/main/resources/CountryInfoService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CountryInfoService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:src/main/resources/CountryInfoService.wsdl");
        }
        WSDL_LOCATION = url;
    }
