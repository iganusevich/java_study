...
public class ContactCreationTests {
    ...
    public void ContactCreationTests() {
        goToAddContactPage();
        fillInForm(new ContactData("Irene", "Mid", "Test", "Igan", "Title", "Company", "ddress", "Home", "Mobile", "Work", "Fax", "E-mail", "E-mail2", "E-mail3", "Homepage", "Address 123", "Home 123", "Notes 123"));
    ...
    private void fillInForm(ContactData contactData) {
        ...
        new Actions(wd).doubleClick(wd.findElement(By.xpath("//div[@id='content']//label[.='Title:']"))).build().perform();
        wd.findElement(By.name("title")).click();
